...
public class GuestModeManager {
    ...
    public static boolean isGuestModeFromActivity(Fragment fragment) {
        if (fragment.getActivity() instanceof com.kartik.messapp.UserDashboardActivity) {
            return ((com.kartik.messapp.UserDashboardActivity) fragment.getActivity()).isGuestMode();
        }
        if (fragment.getActivity() instanceof com.kartik.messapp.MessDashboardActivity) {
            return ((com.kartik.messapp.MessDashboardActivity) fragment.getActivity()).isGuestMode();
        }
        return false;
    }
}
