package com.kartik.messapp.ui.user.profile;
...
public class UserProfileFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding.btnMyReviews.setOnClickListener(v -> {
            Intent intent = new Intent(getActivity(), com.kartik.messapp.MyReviewsActivity.class);
    ...
    private void openMessReviews(boolean openReviewDialog) {
        ...
        Intent intent = new Intent(getActivity(), com.kartik.messapp.MessReviewsActivity.class);
