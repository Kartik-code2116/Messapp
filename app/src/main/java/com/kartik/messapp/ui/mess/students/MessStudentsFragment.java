...
import com.kartik.messapp.databinding.FragmentMessStudentsBinding;
...
public class MessStudentsFragment extends Fragment {
    ...
    private void manageSubscription(Student student, double amount, int days, boolean isExtend, String mealType) {
        ...
        com.kartik.messapp.models.Transaction transaction = new com.kartik.messapp.models.Transaction(
                transId,
                currentMessId,
                student.getUserId(),
                amount,
