package com.kartik.messapp.ui.mess.requests;
...
import com.kartik.messapp.adapters.RequestAdapter;
import com.kartik.messapp.adapters.SubscriptionRequestAdapter;
import com.kartik.messapp.managers.MessNotificationManager;
import com.kartik.messapp.models.MealRequest;
import com.kartik.messapp.models.SubscriptionRequest;
    ...
    private void grantSubscription(SubscriptionRequest request, double amount, int days, String mealType) {
        ...
        db.collection("users").document(request.getStudentId()).get()
                .addOnSuccessListener(doc -> {
                    ...
                    com.kartik.messapp.models.Transaction transaction =
                            new com.kartik.messapp.models.Transaction(
