...
import com.kartik.messapp.databinding.ActivityUserDashboardBinding;
...
public class UserDashboardActivity extends AppCompatActivity {
    ...
    private void setupTopBar() {
        ...
        binding.userTopBar.btnMenuMore.setOnClickListener(v -> showMoreOptionsMenu(v));
    }
    ...
    private void showAboutDeveloperDialog() {
        new AlertDialog.Builder(this)
                ...
                .setMessage("Developer: Kartik Thorat\n" +
                        "Email: kartikthorat2003@gmail.com\n\n" +
    ...
    private boolean isNotificationVisibleForUser(DocumentSnapshot doc, String userId) {
        ...
        if (com.kartik.messapp.managers.MessNotificationManager.TYPE_SUBSCRIPTION_ALERT.equals(type)) {
            return false;
        }
