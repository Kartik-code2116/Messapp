...
public final class FragmentMessMenuBinding implements ViewBinding {
  ...
  @NonNull
  public final Button btnSaveDinner;

  @NonNull
  public final Button btnSaveLunch;
  ...
  private FragmentMessMenuBinding(@NonNull ScrollView rootView, @NonNull Button btnSaveDinner,
      @NonNull Button btnSaveLunch, @NonNull Button btnSelectDate,
  ...
  public static FragmentMessMenuBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      Button btnSaveDinner = ViewBindings.findChildViewById(rootView, id);
      if (btnSaveDinner == null) {
        break missingId;
      }

      id = R.id.btn_save_lunch;
      Button btnSaveLunch = ViewBindings.findChildViewById(rootView, id);
      ...
      return new FragmentMessMenuBinding((ScrollView) rootView, btnSaveDinner, btnSaveLunch,
