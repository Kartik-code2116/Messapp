...
public final class IncludeAdminTopBarBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static IncludeAdminTopBarBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static IncludeAdminTopBarBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.include_admin_top_bar, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static IncludeAdminTopBarBinding bind(@NonNull View rootView) {
