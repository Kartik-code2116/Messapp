...
public final class ActivitySplashScreenBinding implements ViewBinding {
  ...
  private ActivitySplashScreenBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageView appLogo, @NonNull LinearLayout centerContainer,
      @NonNull MaterialCardView logoCard, @NonNull TextView textTitle) {
  ...
  public static ActivitySplashScreenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySplashScreenBinding((ConstraintLayout) rootView, appLogo, centerContainer,
          logoCard, textTitle);
    }
